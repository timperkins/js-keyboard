(function($) {
	...
	Keyboard.prototype.onButtonUp = function(e) {
	...
	Key.prototype.onClick = function(e) {
	...
	LetterKey.prototype.onClick = function(e) {
	...
	CapsKey.prototype.onClick = function(e) {
	...
	DeleteKey.prototype.onClick = function(e) {
	...
	function Logo(keyboard) {
		...
		this.el.src = 'https://www.draw.guru/static/img/logo.png';
	}
	Logo.prototype.onClick = function(e) {
	...
	SpaceKey.prototype.onClick = function(e) {
	...
	SubmitKey.prototype.onClick = function(e) {
